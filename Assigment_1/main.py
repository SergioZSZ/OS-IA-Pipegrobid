#funciones 
from functions import grobid_request
from functions import dw_stopwords
from functions import process_xml
from functions import keyword_gen, figures_gen
from functions import gen_txt
